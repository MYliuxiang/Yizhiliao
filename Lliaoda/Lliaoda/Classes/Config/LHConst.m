...
NSString *const kMessageSuperViewKey = @"kMessageSuperViewKey";
...
NSString *const kRouterEventRechargeBubbleLongTapEventName = @"kRouterEventRechargeBubbleLongTapEventName"; // 點擊去儲值
...
NSString *const kRouterEventTapEventName = @"kRouterEventTapEventName";
