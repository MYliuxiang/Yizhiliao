...
@property(nonatomic,assign)int settled;	//Int	已结算的积分收益(累计已提现)
@property(nonatomic,assign)int video;	//Int	已结算的积分收益
@property(nonatomic,assign)int gift;	//Int	礼物所获得的收益
@property(nonatomic,assign)int share;	//Int	邀请所获得的收益
