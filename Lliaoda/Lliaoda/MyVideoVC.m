...
- (void)handleLongPressGuesture:(UILongPressGestureRecognizer *)guesture {
    ...
    if(guesture.state == UIGestureRecognizerStateEnded){
        ...
        if (row > 0) {
            ...
            UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:@"設定封面" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            UIAlertAction *defaultAction1 = [UIAlertAction actionWithTitle:@"删除" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row == 0) {
        ...
        UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:@"拍摄" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        UIAlertAction *defaultAction1 = [UIAlertAction actionWithTitle:@"从手机相薄选择" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
