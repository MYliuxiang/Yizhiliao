...
//        self.navigationBar.barTintColor = [UIColor colorWithRed:(52/255.0) green:(110/255.0)  blue:(240/255.0) alpha:1.0];
...
- (void)viewDidLoad {
    ...
    // 1.6.10 采用微信的方式，只在相薄列表页定义backBarButtonItem为返回，其余的顺系统的做法
