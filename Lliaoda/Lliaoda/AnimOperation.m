...
//        // i ％ 2 控制最多允许出现几行
        if (_index % 2) {
             _presentView.frame = CGRectMake(-20, 220 * ratioHeight, self.listView.frame.size.width / 2, 50);
        }else {
            
             _presentView.frame = CGRectMake(-20, 150 * ratioHeight, self.listView.frame.size.width / 2, 50);
        }
