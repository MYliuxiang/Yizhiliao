...
+ (NSString *)handleActiveWith:(NSString *)times
{
    ...
    NSString *result;
    if (timeInterval < 60) {
        result = [NSString stringWithFormat:@"%@", LXSring(@"正在活躍")];
    }
    else if((temp = timeInterval/60) <60){
        result = [NSString stringWithFormat:LXSring(@"%ld分鐘前活躍"),temp];
    }
    
    else if((temp = temp/60) <24){
        result = [NSString stringWithFormat:LXSring(@"%ld小時前活躍"),temp];
    }
    
    else if((temp = temp/24) <30){
        result = [NSString stringWithFormat:LXSring(@"%ld天前活躍"),temp];
    }
    
    else if((temp = temp/30) <12){
        result = [NSString stringWithFormat:LXSring(@"%ld月前活跃"),temp];
    }
    else{
        temp = temp/12;
        result = [NSString stringWithFormat:LXSring(@"%ld年前活跃"),temp];
    }
