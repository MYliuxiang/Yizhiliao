...
-(void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < pulsingCount; i++) {
        ...
        scaleAnimation.fromValue = [NSNumber numberWithDouble:42.0 / kScreenWidth / 2.0 ];
    ...
    UIImageView *thumb = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 84, 84)];
...
//    thumbnailLayer.borderColor = [UIColor yellowColor].CGColor;
...
//    for (CALayer *sublayer in self.animationLayer.sublayers) {
//        
