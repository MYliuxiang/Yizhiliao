...
/**
 * 说明:設定中心x与父视图中心的偏移 centerX = 0 与父视图中心x重合
...
/**
 * 说明:設定中心x与相对视图中心的偏移 centerX = 0 与相对视图中心x重合
 * @param centerX: 中心x坐标偏移
 * @param relativeView: 設定相对参考视图
 */
...
/**
 * 说明:設定中心y与父视图中心的偏移 centerY = 0 与父视图中心y重合
...
/**
 * 说明:設定中心y与相对视图中心的偏移 centerY = 0 与相对视图中心y重合
 * @param centerY: 中心y坐标偏移
 * @param relativeView: 設定相对参考视图
 */
...
/**
 * 说明:設定中心偏移(默认相对父视图)center = CGPointZero 与父视图中心重合
 * @param center: 中心偏移xy
 */
...
/**
 * 说明:設定视图显示区域(默认相对父视图,横竖屏宽高可自动收缩)
 * @param frame: 视图显示区域
 */
...
/**
 * 说明:設定视图显示区域(默认相对父视图,横竖屏仅仅宽度自动收缩)
 * @param frame: 视图显示区域
 * @param relativeView: 設定相对参考视图
 */
...
/**
 * 说明:設定视图显示区域(默认相对父视图,横竖屏仅仅高度自动收缩)
 * @param frame: 视图显示区域
 */
