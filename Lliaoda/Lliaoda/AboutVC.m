...
- (void)_initViews
{
    ...
    if ([lang hasPrefix:@"zh-Hant"]) {
        ...
        urlstring = [NSString stringWithFormat:@"https://arab-candy-public.oss-me-east-1.aliyuncs.com/pages/ar-sa/aboutus.html?app=talktome&v=%@",[infoDictionary objectForKey:@"CFBundleShortVersionString"]];
    }else{
        urlstring = [NSString stringWithFormat:@"https://static.yizhiliao.tv/pages/zh-tw/aboutus.html?v=%@",[infoDictionary objectForKey:@"CFBundleShortVersionString"]];
    }
